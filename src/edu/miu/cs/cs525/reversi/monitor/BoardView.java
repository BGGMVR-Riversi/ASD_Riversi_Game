...
public class BoardView extends JPanel
{
    ...
    private void jbInit() throws Exception
    {
        ...
        pauseBeforeMoveTimer = new Timer( 100, new boardView_PBMTimer_actionAdapter( this ) ) ;
...
class boardView_this_mouseAdapter extends java.awt.event.MouseAdapter
{
    BoardView adaptee ;

    boardView_this_mouseAdapter( BoardView adaptee )
    {
...
class boardView_timer_actionAdapter implements java.awt.event.ActionListener
{
    BoardView adaptee ;

    boardView_timer_actionAdapter( BoardView adaptee )
    {
        this.adaptee = adaptee ;
    }
...
class boardView_PBMTimer_actionAdapter implements java.awt.event.ActionListener
{
    BoardView adaptee ;

    boardView_PBMTimer_actionAdapter( BoardView adaptee )
    {
        this.adaptee = adaptee ;
    }
